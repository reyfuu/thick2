...
<li class="sidebar-header">
	...
	<li class=""> 
       ...
       <li class="has-sub"> 
        ...
        <i class="flaticon-user"></i>   Project
         </a>
								...
								<div class="col-lg-12 px-2">
									<div class="submenu-box"> 
										<ul class="list-unstyled m-0">
											<li><a href="">Daftar Project</a></li>
											<li><a href="">Progress</a></li>
										    <li><a href=""> Report Project</a></li>
           ...
           <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Thick</span>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-left">
							<p class="mb-0">
								<a href="index.html" class="text-muted"><strong>Dashboard Thick </strong></a> &copy
							</p>
						</div>
  ...
  <script src="<?= base_url('/asset/js/dash.js');?>"></script> 
  </body>
</html>
