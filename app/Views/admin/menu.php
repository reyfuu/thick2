...
<li class="sidebar-header">
	...
	<li class=""> 
		  <a class="nav-link text-left <?php if($title == 'Dashboard'){ echo 'active';} ?>" href="<?= base_url('/admin'); ?>" role="button" 
								...
								<div class="col-lg-12 px-2">
									<div class="submenu-box"> 
										<ul class="list-unstyled m-0">
											<li><a href="<?= base_url('/admin/daftar-project'); ?>">Daftar Proyek</a></li>
